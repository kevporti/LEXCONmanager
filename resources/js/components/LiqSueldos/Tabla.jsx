...
function Tabla() {
    return (
        <div className="w-full border border-lightwhite rounded">
            <div className="px-4 py-2 border-b-2 border-lightwhite bg-dark grid grid-cols-5 print:text-lg print:grid print:grid-cols-4 print:font-medium">
                ...
                <div className="print:hidden grid place-content-end">
                    Opciones
                </div>
            </div>
            <FilaTabla />
