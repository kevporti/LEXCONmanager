...
export default function Agregar() {
    ...
    async function handleContacto(e) {
        let item = {
            ...
            telefonoContacto,
            emailContacto,
            firmaUsuarioContacto,
        };
        console.log(item);
        await axios
            .post("http://127.0.0.1:8000/api/usuario/agregarContactos", item)
            .then((response) => {
    ...
    return (
        <>
            <div className="flex items-center justify-center">
                ...
                >
                    <h1 className="mr-2">Agregar Contacto</h1>
                                    ...
                                    <div className="mt-2">
                                        ...
                                        <form className="text-sm text-gray-400 grid grid-cols-2 gap-4">
                                            ...
                                            <div className="grid grid-cols-1">
                                                ...
                                                <input
                                                    onChange={(e) =>
                                                        setfirmaUsuarioContacto(
                                                            e.target.value
                                                        )
                                                    }
                                                    name="firmaUsuarioContacto"
                                                    type="text"
